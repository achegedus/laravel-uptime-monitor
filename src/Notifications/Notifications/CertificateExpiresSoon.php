...
use achegedus\UptimeMonitor\Events\CertificateExpiresSoon as SoonExpiringSslCertificateFoundEvent;

class CertificateExpiresSoon extends BaseNotification
{
    /** @var \achegedus\UptimeMonitor\Events\CertificateExpiresSoon */
    public $event;
